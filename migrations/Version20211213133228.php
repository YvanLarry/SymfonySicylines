 ...
 */
final class Version20211213133228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liaison_periode_type (id INT AUTO_INCREMENT NOT NULL, liaison_id INT DEFAULT NULL, periode_id INT DEFAULT NULL, type_id INT DEFAULT NULL, tarif INT NOT NULL, INDEX IDX_EB210873ED31185 (liaison_id), INDEX IDX_EB210873F384C1CF (periode_id), INDEX IDX_EB210873C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
